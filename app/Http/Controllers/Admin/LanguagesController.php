...
class LanguagesController extends Controller
{
    ...
    public function edit($id){
       ...
       if(!@$language)
           return redirect()->route('admin.languages')->with(['error'=>'اللغة المختارة غير موجودة']);
    ...
    public function update($id,LanguageRequest $request){
       ...
       // try {
        ...
        if(!@$language)
            return redirect()->route('admin.languages.edit',$id)->with(['error'=>'اللغة المختارة غير موجودة']);
